...
class PomodoroTimer:
    def __init__(self):
        ...
        self.timer_label = ttk.Label(self.root, text="25:00", font=("Helvetica", 40))
        self.timer_label.pack(pady=20)

        self.start_button = ttk.Button(self.root, text="Start Pomodoro", command=self.start_timer)
            ...
            if self.is_work_time:
                ...
                if self.work_time == 0:
                    ...
                    messagebox.showinfo("Great Job!" if self.pomodoros_completed % 4 == 0
                                        else "Good Job!", "Time for a long break!" if self.pomodoros_completed % 4 == 0 else "Time for a short break and stretch your legs!")
            else:
                self.break_time -= 1
